...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "IVuJatJP1Kqrav3lVSYcrw";       // Change this
    public static final String REST_CONSUMER_SECRET = "tBreJjHRwG3qVxaWuKUrbIRreWd1Y4UcVv1VV0DYFbk"; // Change this
    ...
    public void updateTweet(String str, AsyncHttpResponseHandler handler){
    	String strUrl=getApiUrl("statuses/update.json");
    	RequestParams params = new RequestParams();
    	params.put("status", str);
    	getClient().post(strUrl, params, handler);
    }
    // CHANGE THIS
